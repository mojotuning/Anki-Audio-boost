...
REVIEW_WINDOW_BLOCKS = 240   # bloques acumulados por cada chunk de revisión (~5 s)
PRED_WINDOW_BLOCKS   = 24    # bloques acumulados antes de cada predicción (~500 ms)
PRED_VOTE_WINDOW     = 2     # cuántas predicciones se votan (2 × 500 ms = 1 s suavizado)
